...
namespace xbytechat.api.Migrations
{
    ...
    [Migration("20251004074126_FlowExecLogs_CascadeToFlow")]
    partial class FlowExecLogs_CascadeToFlow
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("xbytechat.api.Features.Tracking.Models.TrackingLog", b =>
                {
                    ...
                    b.Property<Guid?>("CampaignSendLogId1")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("xbytechat.api.Features.MessageManagement.DTOs.MessageStatusLog", b =>
                {
                    ...
                    b.HasOne("xbytechat.api.Features.CampaignModule.Models.Campaign", null)
                        .WithMany("MessageStatusLogs")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("xbytechat.api.Features.Tracking.Models.TrackingLog", b =>
                {
                    ...
                    b.HasOne("xbytechat.api.Features.CampaignTracking.Models.CampaignSendLog", null)
                        .WithMany()
                    ...
                    b.HasOne("xbytechat.api.Features.CampaignTracking.Models.CampaignSendLog", "CampaignSendLog")
                        .WithMany()
                        .HasForeignKey("CampaignSendLogId1");

                    b.HasOne("xbytechat.api.CRM.Models.Contact", "Contact")
                        .WithMany()
                        .HasForeignKey("ContactId");

                    b.HasOne("MessageLog", null)
                        .WithMany()
                        .HasForeignKey("MessageLogId")
                        .OnDelete(DeleteBehavior.Restrict);
